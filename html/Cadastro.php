        ...
        <section>
            <form action="Cadastro.php" method="POST" class="container" id="form">
                <div class="form-control form-control-lg input-container">
                    ...
                    <input class="form-control" type="text" name="nomeMaterno" id="nomeMaterno" minlength="15"
                        maxlength="60">

                    <label class="col-form-label" for="cpf">CPF:</label>
                    <input class="form-control" type="text" id="cpf" name="cpf" placeholder="XXX.XXX.XXX-XX" required
